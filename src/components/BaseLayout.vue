<template lang='pug'>
  span
    v-app-bar(app color="#6E0AD6" prominent flat shrink-on-scroll dark)
      ...
      div(:style='{ color: "rgba(255, 255, 255," + textOpacity + ")" }' style='align-self: center !important; margin: auto; font-size: 80%; font-weight: 600; padding: 8px 0 0 0; text-align: center;') {{ text }} 
      .avatar-custom
        v-icon {{ icon }}
    v-main
